...
```bash
WORKFORCE_TARGET_URL=http://127.0.0.1:4000/api/v1/workforce-intelligence/events
```
...
Note: The simulator expects `dewr-workforce-intelligence-services` to be running and reachable at `WORKFORCE_TARGET_URL` (default: `http://127.0.0.1:4000/api/v1/workforce-intelligence/events`).
